          ...
          >
            ...
            <div class="p-4 space-y-2">
              ...
              <div class="flex justify-between items-center mt-3">
                <NuxtLink :to="`/noleggio/${slugify(v.titolo)}-${v.codice}`" class="bg-[#A30000] hover:bg-red-800 text-white px-4 py-1.5 text-sm rounded shadow">
                  Dettagli
                </NuxtLink>
        ...
        <div v-else-if="vista === 'lista'" class="space-y-4">
          ...
          >
            ...
            <div class="flex-1 space-y-1">
              ...
              <p class="text-xs text-white/50">Prezzo: {{ v.prezzo ? v.prezzo + ' €' : 'n.d.' }}</p>
              <p class="text-xs text-white/50">Venditore: {{ v.venditore }}</p>
              <NuxtLink :to="`/noleggio/${slugify(v.titolo)}-${v.codice}`" class="inline-block mt-2 bg-[#A30000] hover:bg-red-800 text-white px-4 py-1.5 text-sm rounded shadow">
                Dettagli
              </NuxtLink>
            </div>
          </div>
